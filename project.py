...
def dhash(image_path, hash_size=8):
    ...
    image = cv2.imread('C:\\Users\\DELL\\Downloads\\instagram-image-size - Copy.jpg')
...
def detect_image_forgery(original_path, manipulated_path, threshold=5):
    ...
    if similarity <= threshold:
        print("Image forgery detected!")
    else:
        print("Images are likely different.")

# Example usage
original_image_path =  'C:\\Users\\DELL\\Downloads\\instagram-image-size - Copy.jpg'
manipulated_image_path =  'C:\\Users\\DELL\\Pictures\\wp3785670.jpg'
